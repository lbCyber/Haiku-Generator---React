...
class Intro extends Component {
  ...
  doGenerate = () => {
    document.getElementById("topContentBox").setAttribute('class', 'topContentBox hideContent')
    setTimeout(() => this.props.makeGenerate(true), 2000)
  }

  render() {
    return (
      <div className="topContentBox" id="topContentBox">
        <div className="topContent">
          ...
          <div className="frontText">
            ...
            <div className="startButton">
              ...
              <div className="downOne" onClick={()=>this.doGenerate()}></div>
            </div>
          </div>
        </div>
      </div>
